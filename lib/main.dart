...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          backgroundColor: Color(0xff0C3150),
          title: Text("SJC",style: TextStyle(fontWeight: FontWeight.bold),),
        ),
        body: GoldListView(),
      ),
    );
          ...
          Expanded(
            child: Container(
              ...
              child: Text(
                gold.type,
                style: TextStyle(
                    color: Color(0xffFBF203), fontWeight: FontWeight.bold),
              ),
            ),
          ),
          Expanded(
            ...
            child: Center(
              child: Text(
                gold.inGold,
                style: TextStyle(
                    color: index == 0 ? Color(0xffFBF203) : Colors.white,
